...
// Reads the current client's pets from the web backend. Mirrors
// VehiclesService's Bearer-token GET pattern against /api/seller/pets.
enum PetsService {
    ...
    static func fetch(page: Int = 0) async throws -> Response {
        ...
        var components = URLComponents(
            url: Config.apiBaseURL.appendingPathComponent("api/seller/pets"),
