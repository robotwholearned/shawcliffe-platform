...
struct StorefrontView: View {
    ...
    private var actionButtons: some View {
        VStack(spacing: 12) {
            NavigationLink {
                SignupView(businessName: businessName, primaryColor: primaryColor, fontDesign: fontDesign)
            } label: {
                Text("Get Updates")
                    .bold()
                    .frame(maxWidth: .infinity)
            ...
            NavigationLink {
                PreorderView(businessName: businessName, products: viewModel.products, primaryColor: primaryColor, fontDesign: fontDesign)
            } label: {
            ...
            if viewModel.enabledComponents.contains(ComponentKeys.documentChecklistIntake) {
                NavigationLink {
                    DocumentChecklistView(businessName: businessName, primaryColor: primaryColor, fontDesign: fontDesign)
                } label: {
