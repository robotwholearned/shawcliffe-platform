...
// Reads the current client's vehicles from the web backend. Mirrors
// DocumentSubmissionsService's Bearer-token GET pattern against
// /api/seller/vehicles.
enum VehiclesService {
    ...
    static func fetch(page: Int = 0) async throws -> Response {
        ...
        var components = URLComponents(
            url: Config.apiBaseURL.appendingPathComponent("api/seller/vehicles"),
